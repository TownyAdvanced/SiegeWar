...
public class SiegeWarSettings {
	...
	public static boolean areBattlePointsWinnerTakesAll() {
		return Settings.getBoolean(ConfigNodes.POINTS_BALANCING_END_OF_BATTLE_POINTS_DISTRIBUTION_WINNER_TAKES_ALL);
	}

	public static int getWarBattlePointsForAttackerOccupation() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_BASE_POINTS_BANNER_CONTROL_ATTACKER);
	}

	public static int getWarBattlePointsForDefenderOccupation() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_BASE_BANNER_CONTROL_POINTS_DEFENDER);
	}

	public static int getWarBattlePointsForAttackerDeath() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_BASE_POINTS_DEATHS_ATTACKER);
	}

	public static int getWarBattlePointsForDefenderDeath() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_BASE_POINTS_DEATHS_DEFENDER);
	}
	...
	public static boolean isWarSiegeCounterattackBoosterEnabled() {
		return Settings.getBoolean(ConfigNodes.POINTS_BALANCING_COUNTERATTACK_BOOSTER_ENABLED);
	}

	public static double getWarSiegeCounterattackBoosterExtraDeathPointsPerPlayerPercentage() {
		return Settings.getDouble(ConfigNodes.POINTS_BALANCING_COUNTERATTACK_BOOSTER_EXTRA_DEATH_POINTS_PER_PLAYER_PERCENTAGE);
	}
	...
	public static String getWarSiegeBattleSessionWeekdayStartTimes() {
		return Settings.getString(ConfigNodes.POINTS_BALANCING_BATTLE_SESSION_TIMINGS_START_TIMES_WEEKDAYS);
	}

	public static String getWarSiegeBattleSessionWeekendStartTimes() {
		return Settings.getString(ConfigNodes.POINTS_BALANCING_BATTLE_SESSION_TIMINGS_START_TIMES_WEEKEND_DAYS);
	}

	public static int getWarSiegeBattleSessionDurationMinutes() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_BATTLE_SESSION_TIMINGS_DURATION_MINUTES);
	}
	...
	public static boolean isWarSiegeBannerControlReversalBonusEnabled() {
		return Settings.getBoolean(ConfigNodes.POINTS_BALANCING_BANNER_CONTROL_REVERSAL_BONUS_ENABLED);
	}

	public static double getWarSiegeBannerControlReversalBonusFactor() {
		return Settings.getDouble(ConfigNodes.POINTS_BALANCING_BANNER_CONTROL_REVERSAL_BONUS_MULTIPLIER);
	}
	...
	private static int getBattleSessionCappingLimiterWeekdays() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_CAPPING_LIMITER_WEEKDAYS);
	}

	private static int getBattleSessionCappingLimiterWeekendDays() {
		return Settings.getInt(ConfigNodes.POINTS_BALANCING_CAPPING_LIMITER_WEEKEND_DAYS);
	}
