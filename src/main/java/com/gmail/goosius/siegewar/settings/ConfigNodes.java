...
public enum ConfigNodes {
	...
	WAR_SIEGE_BANNER_PLACE_DISTANCE_TOWN_BLOCKS_MAX(
			...
			"1",
			"",
			"# The maximum distance in Town Blocks that a banner can be placed from a town, where 1 is adjacent.",
	...
	WAR_SIEGE_BANNER_PLACE_DISTANCE_TOWN_BLOCKS_MIN(
			...
			"1",
			"",
			"# The minimum distance in Town Blocks that a banner must be placed from a town, where 1 is adjacent.",
			"# This distance applies both to surrendering and starting sieges.",
			"# Setting this value to below '1' will use 1 Town Block distance.",
