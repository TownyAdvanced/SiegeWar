...
public enum ConfigNodes {
	...
	POST_WAR_NATION_IMMUNITY_ENABLED(
			...
			"# ",
			"# This feature ensures that non-aggressive nations cannot be forced to fight continuously,",
			"# by granting siege-immunity to all of their towns, after any period of continuous fighting.",
			"# ",
			"# This effect is achieved as follows:",
			"# 1. The max number of consecutive hometown-defence sieges is limited.",
			"# 2. After each period of continuous fighting (a.k.a war), each town in the nation gets some siege immunity.",
			"# 3. To mitigate exploits, nations suffer some mild negative effects during hometown-defence sieges - cannot claim/unclaim/recruit.",
			"# 4. To mitigate annoyance-sieges, the cost to attack a nation hometown increases as the defending nation increases in size.",
			"# ",
			"# NOTE: ",
			"# If a town switches home nation during a siege",
			"# then when the siege ends, the post-war siege immunity is distributed",
			"# between all the home nations which the town had during the course of the siege"),
