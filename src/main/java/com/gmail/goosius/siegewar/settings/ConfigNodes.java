...
public enum ConfigNodes {
	...
	HOME_DEFENCE_SIEGE_EFFECTS_ENABLED(
			...
			"# Summary: ",
			"#   * If a nation home town is attacked, mid-siege effects and post-siege effects are received by the entire home nation.",
			"# Benefits to Players:",
			...
			"#   * Aggressive nations can ignore these benefits if they wish, by attacking/occupying foreign towns, or by having home towns revolt.",
			"# Costs to Players:",
			"#   * During a siege, all nation home towns receive the usual negative siege effects (pvp on, no recruiting/claiming etc.).",
			"#   * Note the exception of peaceful towns, who do not get the pvp switch.",
			"# Benefits to Server:",
