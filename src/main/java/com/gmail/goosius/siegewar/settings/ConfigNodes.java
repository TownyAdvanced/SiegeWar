...
public enum ConfigNodes {
	...
	NATION_SIEGE_EFFECTS(
		"nation_siege_effects",
			...
			"############################################################",
			""),
	NATION_SIEGE_EFFECTS_ENABLED(
			"nation_siege_effects.enabled",
			"true",
			"",
			"# If this setting is true, then if a nation town is attacked,",
			"# the entire nation receives siege effects, & post-siege-immunity.",
			"# ",
			"# If this setting is false, then if a nation town is attacked",
			"# only the attacked town receives siege effects & post-siege immunity.",
			"# ",
			"# PURPOSE:",
			"# 1.",
			"# Nation residents generally play as a team on the nation level,",
			"# so for moderate to large nations, town immunity is not sufficient,",
			"# to prevent the team being forced into exhaustive continuous fighting in defence",
			"# 2.",
			...
			"# because neither offensive sieges not revolt sieges from occupied towns are restricted by these effects",
			"# ",
			"# NATION EFFECTS: ",
			"# - Towns cannot join nation",
			"# NATION TOWN EFFECTS: ",
			"# - PVP forced on.",
      		"# - Cannot claim.",
      		"# - Cannot unclaim.",
	...
	NATION_SIEGE_EFFECTS_SIEGE_IMMUNITY_MODIFIER(
