...
public enum ConfigNodes {
	...
	POST_WAR_NATION_IMMUNITY_ENABLED(
			...
			"# 1. The number of simultaneous attacks on the nation's towns is limited.",
			"# 2. After a home-defence war ends, each of the nation's town gets some siege immunity.",
			"# 3. To mitigate exploits, the nation suffers some mild negative effects while fighting a home-defence war: cannot claim/unclaim/recruit.",
