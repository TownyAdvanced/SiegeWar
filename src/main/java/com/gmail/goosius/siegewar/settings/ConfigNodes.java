...
public enum ConfigNodes {
	...
	POST_WAR_NATION_IMMUNITY_ENABLED(
			...
			"# by granting siege-immunity to all its hometowns, after any period of continuous hometown-defence.",
			"# ",
			"# Effects on Each Nation:",
			"# 1. The number of simultaneous attacks on the nation's hometowns is limited to a certain number (configurable - see next setting).",
			"# 2. After the nation exits any period of continuous hometown-defence, each hometown gets some siege immunity.",
			"# 3. To mitigate exploits, the nation suffers some mild negative effects while fighting in hometown-defence: cannot claim/unclaim/recruit.",
			"# 4. To mitigate annoyance-sieges, the cost to attack any hometown increases as the nation increases in size.",
			"# ",
			"# NOTE: ",
