...
public enum ConfigNodes {
	...
	TRAP_WARFARE_MITIGATION_BESIEGED_TOWN(
			"trap_warfare_mitigation.besieged_town",
			"",
			"",
			"",
			"# +------------------------------------------------------+ #",
			"# |       TRAP WARFARE MITIGATION - BESIEGED TOWN        | #",
			"# +------------------------------------------------------+ #",
			""),
	TRAP_WARFARE_MITIGATION_BESIEGED_TOWN_ENABLED(
			"trap_warfare_mitigation.besieged_town.enabled",
			"true",
			"",
			"# If this setting is true, then players in the besieged town cannot build/destroy blocks near the siege banner.",
			"# TIP 1: The feature reduces the impact of safe-claim traps.",
			"# TIP 2: This feature emphasises the important of pre-prepared town defences (e.g. walls, towers etc.)."),
	TRAP_WARFARE_MITIGATION_BESIEGED_TOWN_RADIUS(
			"trap_warfare_mitigation.besieged_town.radius",
			"32",
			"",
	...
	TRAP_WARFARE_MITIGATION_WILDERNESS(
			"trap_warfare_mitigation.wilderness",
			"",
			"",
			"",
			"# +------------------------------------------------------+ #",
			"# |       TRAP WARFARE MITIGATION - WILDERNESS           | #",
			"# +------------------------------------------------------+ #",
			""),
	TRAP_WARFARE_MITIGATION_WILDERNESS_ENABLED(
			"trap_warfare_mitigation.wilderness.enabled",
			"true",
			"",
	...
	TRAP_WARFARE_MITIGATION_WILDERNESS_RADIUS(
			"trap_warfare_mitigation.wilderness.radius",
			"32",
			"",
	...
	TRAP_WARFARE_MITIGATION_WILDERNESS_UPPER_HEIGHT_LIMIT(
			"trap_warfare_mitigation.wilderness.upper_height_limit",
			"10",
			"",
