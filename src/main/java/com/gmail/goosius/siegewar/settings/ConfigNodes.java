...
public enum ConfigNodes {
	...
	HOME_DEFENCE_SIEGE_EFFECTS_ENABLED(
			...
			"# its entire home nation receives siege effects.",
			"# ",
			"# If this setting is false, then if a nation town is attacked",
			"# only the attacked town receives siege effects.",
			"# ",
			"# PURPOSE:",
			"# 1.",
			"# Players in a nation generally play as a team on the nation level,",
			...
			"# because neither offensive sieges, nor sieges involving occupied foreign towns are restricted by the feature.",
			"# ",
			"# HOME NATION EFFECTS: ",
			"# - Towns cannot join nation",
			"# HOME NATION TOWN EFFECTS: ",
			"# - PVP forced on.",
      		"# - Cannot claim.",
      		"# - Cannot unclaim.",
