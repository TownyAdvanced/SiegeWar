...
public enum ConfigNodes {
	...
	WAR_SIEGE_MAP_HIDING_ENABLED(
			...
			"# Note 1: After the required conditions for map-hiding are met, the effect does not activate instantly, but takes a few seconds (same for de-activation).",
			"# Note 2: Map hiding does not activate when a player is trying to get banner control.",
	...
	WAR_SIEGE_MAP_HIDING_MODE(
			...
			"# - See user guide for details on how this can affect overall gameplay.",
			"# ",
			"# AUTOMATIC :",
