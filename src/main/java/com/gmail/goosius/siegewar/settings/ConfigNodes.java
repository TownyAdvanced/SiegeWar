...
public enum ConfigNodes {
    ...
    WAR_SIEGE_POINTS_BALANCING_WALL_BREACH_BONUS(
			...
			"# +------------------------------------------------------+ #",
			""),
	WAR_SIEGE_POINTS_BALANCING_WALL_BREACH_BONUS_POINTS(
			"war.siege.points_balancing.wall_breach_bonus.points",
			"200",
			"",
			"# This value determines the number of bonus battle points awarded by the Wall-Breach Bonus.",
			"# The bonus is awarded if a player from the 'hostile-to-town' team caps the banner and then gets to the homeblock.", 
            "# The bonus is awarded a max of once per player per battle session.",
			"# To disable this feature, set the value to -1",
			"# TIP: Even if your server has impervious walls (e.g. no pearls or cannons),",
		    "# it is probably still OK to enable this feature, because it encourages town-fortification building, without denying anyone the ability to win battles via the standard methods (capping and killing)."),
