...
public enum ConfigNodes {
	...
	TRAP_WARFARE_MITIGATION_BESIEGED_TOWN_ENABLED(
			...
			"true",
			"",
			"# If this setting is true, then surface warfare is encouraged in the besieged town as follows:",
			"# * Players in the besieged town cannot build/destroy blocks near the siege banner, thus cannot create 'Safe Claim Ganks'.",
			"# * Defenders are compensated by forcing the siege banner to be right on the town border."),
	...
	TRAP_WARFARE_MITIGATION_BESIEGED_TOWN_BORDER_SIEGE_BANNER_ENABLED(
			"surface_warfare.besieged_town.border_siege_banner_enabled",
			"true",
			"",
			"# If true, the siege banner must be placed right on border of the besieged town.",
			"# This setting compensates defenders for the loss of safe-claim ganks, by bringing the attackers closer to the town and its fortifications (walls,towers etc.).",
			"# ",
			"# This settings has 2 additional important effects:",
			"# 2. Encourages good town fortifications to be built, as they cannot be build after the siege starts.",
			"# 3. Makes sieges more atmospheric (i.e. now we fight at the town walls, not in a nearby field..."),
	...
	TRAP_WARFARE_MITIGATION_WILDERNESS_ENABLED(
			...
			"true",
			"",
			"# If this setting is true, then players in the wilderness cannot build/destroy blocks near active siege banners.",
			"# TIP: If this feature is enabled,",
