...
public enum ConfigNodes {
	...
	POST_WAR_NATION_IMMUNITY_ENABLED(
			...
			"# 4. To mitigate annoyance-sieges, the cost to attack a nation town increases as the defending nation increases in size."),
	...
	POST_WAR_NATION_IMMUNITY_HOME_TOWN_CONTRIBUTION_TO_ATTACK_COST(
			...
			"# because large nations are disproportionately affected by the mild under-siege costs.",
