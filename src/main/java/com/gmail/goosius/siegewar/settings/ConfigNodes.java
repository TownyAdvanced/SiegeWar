...
public enum ConfigNodes {
	...
	WAR_SIEGE_SWITCHES_TRAP_WARFARE_MITIGATION_ENABLED(
			...
			"# be sure to add a behaviour-rule like this: Before the banner is placed, players must ensure there no traps in the wilderness near the banner."),
	...
	WAR_SIEGE_BATTLE_SESSIONS(
			...
			"############################################################",
			""),
	WAR_SIEGE_BATTLE_SESSIONS_START_TIME_CLIP(
			"war.siege.battle_sessions.start_time_clip",
			"10",
			"",
			"# This value determines the start time of each battle session.",
			"# Example: If this value is 10, every battle session will start at 10 minutes past the hour."),
	WAR_SIEGE_BATTLE_SESSIONS_DURATION_MINUTES(
			...
			"# TIP: The default duration of 50, combined with the default start time clip of 10,",
			"# means that every battle session will end on the hour, followed by a 10 minute break."),
