...
public enum ConfigNodes {
	...
	PEACEFUL_TOWNS_PUBLIC_SPAWN_ENABLED(
			...
			"# ",
			"# TIP 1:",
			"# In Towny in 2023, many peaceful-builder players have a CRITICAL REQUIREMENT to own public/ally spawns, so that they can run-shops/demonstrate-builds.",
			"# In Servers where public/ally nation spawns are enabled, but public/ally town spawns are disabled, players often meet this requirement by creating 'Shell Nations', which they use just for the nation spawns.",
			"# SiegeWar cannot/will-not protect 'Shell Nations',",
			"# Thus, set this value to 'true' to meet a critical requirement for peaceful-builder players.",
			"# ",
			"# TIP 2:",
			"# In Towny in 2023, the reason some servers disable public/ally town spawns, is to encourage 'infastructure' between towns.",
