...
public enum ConfigNodes {
	...
	WAR_SIEGE_BATTLE_SESSIONS_START_TIME_CLIP(
			...
			"# Example: If this value is 10, every battlewar.siege.battle_sessions.duration_minutes session will start at 10 minutes past the hour."),
	WAR_SIEGE_BATTLE_SESSIONS_DURATION_MINUTES(
			...
			"# TIP: Combined with the default start time clip of 10, ",
			"# the default duration of 50 means that every battle session will end on the hour,",
