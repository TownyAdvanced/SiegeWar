...
public enum ConfigNodes {
	...
	POST_WAR_NATION_IMMUNITY_ENABLED(
			...
			"# 2. After each period of continuous fighting (a.k.a war), every town in the nation gets siege immunity.",
			...
			"# 4. To mitigate annoyance-sieges, the cost to attack a hometown increases as the defending nation increases in size."),
