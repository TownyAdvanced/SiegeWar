...
public enum ConfigNodes {
	...
	WAR_SIEGE_MAP_HIDING_ENABLED(
			...
			"# This feature allow players to disappear from the dynmap, enhancing gameplay.",
			"# PREREQUISITE: Dynmap plugin",
			"# ACTIVATION_TIME: After player conditions for map-hiding are met, the effect does not activate instantly, but takes a few seconds (same for de-activation).",
			"# BANNER CONTROL EXCEPTION: Map hiding does not activate when a player is trying to get banner control."),
	WAR_SIEGE_MAP_HIDING_MODE(
			"war.siege.map_hiding.mode",
			"AUTOMATIC",
			"",
			...
			"# - See user guide for details on how this can affect gameplay."),
	WAR_SIEGE_MAP_HIDING_ITEMS(
			"war.siege.map_hiding.items",
