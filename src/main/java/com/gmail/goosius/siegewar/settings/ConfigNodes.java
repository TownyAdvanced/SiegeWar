...
public enum ConfigNodes {
	...
	WAR_SIEGE_ATTACKER_PLUNDER_DISTRIBUTION_RATIO(
			...
			"# The rank permissions which affect pay are as follows: ",
			"# towny.nation.siege.pay.grade.100 .... a 100% (normal) share of plunder",
			"# towny.nation.siege.pay.grade.150 .... an 150% share of plunder",
