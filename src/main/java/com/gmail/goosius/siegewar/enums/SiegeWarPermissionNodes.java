...
public enum SiegeWarPermissionNodes {
	...
	SIEGEWAR_COMMAND_SIEGEWAR("siegewar.command.siegewar.*"),
		SIEGEWAR_COMMAND_SIEGEWAR_NATION("siegewar.command.siegewar.nation.*"),
	    	...
	    	SIEGEWAR_COMMAND_SIEGEWAR_NATION_REMOVE_OCCUPIER("siegewar.command.siegewar.nation.removeoccupier"),
	    	SIEGEWAR_COMMAND_SIEGEWAR_NATION_TRANSFER_OCCUPIER("siegewar.command.siegewar.nation.transferoccupier"),
