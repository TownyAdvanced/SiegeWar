...
public class StartSuppressionSiege {
    ...
    public static void processStartSiegeRequest(Player player,
		...
		SiegeController.startSiegeCampProcess(player, bannerBlock, SiegeType.SUPPRESSION, targetTown, nationOfSiegeStarter, targetTown, townOfSiegeStarter, townBlock);
